const shortDate = (dt) => {
  ...
  const Display = (bold) => {
    axios.get(`https://api.openweathermap.org/data/2.5/weather?q=${bold}&units=imperial&appid=d155f4746e7f77e3912e3f7d86e0bc31`)
      .then(res => {
        ...
        // gets 5 day forecast
        axios.get(`https://api.openweathermap.org/data/2.5/onecall?lat=${weather.coord.lat}&lon=${weather.coord.lon}&units=imperial&appid=d155f4746e7f77e3912e3f7d86e0bc31`)
          .then(resp => {
